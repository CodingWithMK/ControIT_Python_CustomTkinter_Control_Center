...
class VolumeControlsApp(customtkinter.CTk):
    def __init__(self):
        ...
        volume_percent_label = customtkinter.CTkLabel(self, text='Volume: 0%')
        volume_percent_label.pack(pady=10)
    ...
    def set_volume(self, value):
        ...
        # Updating the volume percentage label
        self.volume_percent_label.configure(text=f'Volume: {volume}%')
